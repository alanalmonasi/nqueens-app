...
describe('testing ChessBoard component', () => { 
   ...
   test('Number of solutions should be 2 if board size is 4', () => { 
      ...
      expect(screen.getByLabelText("total-solutions").innerHTML).toContain("Total solutions for this board size: 2")
   });
   ...
   test('Number of solutions should be 92 if board size is 8', () => { 
      ...
      expect(screen.getByLabelText("total-solutions").innerHTML).toContain("92")
   });
